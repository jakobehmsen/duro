...
public class Instruction implements Serializable {
	...
	public static final int OPCODE_CALL = 10;
	public static final int OPCODE_RET = 11;
	public static final int OPCODE_RET_THIS = 12;
	public static final int OPCODE_DEF = 13;
	public static final int OPCODE_IF_TRUE = 14;
	public static final int OPCODE_IF_FALSE = 15;
	public static final int OPCODE_JUMP = 16;
	public static final int OPCODE_SET = 17;
	public static final int OPCODE_GET = 18;
	public static final int OPCODE_LOAD_THIS = 19;
	public static final int OPCODE_LOAD_NULL = 20;
	public static final int OPCODE_LOAD_LOC = 21;
	public static final int OPCODE_LOAD_ARG = 22;
	public static final int OPCODE_LOAD_INT = 23;
	public static final int OPCODE_LOAD_FUNC = 24;
	public static final int OPCODE_LOAD_TRUE = 25;
	public static final int OPCODE_LOAD_FALSE = 26;
	public static final int OPCODE_LOAD_STRING = 27;
