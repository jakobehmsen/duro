...
public class Instruction implements Serializable {
	...
	public static final int OPCODE_SWAP_ANY = 10;
	public static final int OPCODE_SEND = 11;
	public static final int OPCODE_CALL = 12;
	public static final int OPCODE_RET = 13;
	public static final int OPCODE_RET_THIS = 14;
	public static final int OPCODE_DEF = 15;
	public static final int OPCODE_IF_TRUE = 16;
	public static final int OPCODE_IF_FALSE = 17;
	public static final int OPCODE_JUMP = 18;
	public static final int OPCODE_SET = 19;
	public static final int OPCODE_GET = 20;
	public static final int OPCODE_LOAD_THIS = 21;
	public static final int OPCODE_LOAD_NULL = 22;
	public static final int OPCODE_LOAD_LOC = 23;
	public static final int OPCODE_LOAD_ARG = 24;
	public static final int OPCODE_LOAD_INT = 25;
	public static final int OPCODE_LOAD_FUNC = 26;
	public static final int OPCODE_LOAD_TRUE = 27;
	public static final int OPCODE_LOAD_FALSE = 28;
	public static final int OPCODE_LOAD_STRING = 29;
