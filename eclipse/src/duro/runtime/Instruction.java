...
public class Instruction implements Serializable {
	...
	public static final int OPCODE_FORWARD_CALL = 15;
	...
	public static final int OPCODE_SET_CODE = 23;
	@ExpressionCompatible(operandTypes = {String.class, Integer.class}, popCount = 2)
	public static final int OPCODE_SET_PROTO = 24;
	public static final int OPCODE_SET_PROTO_CODE = 25;
	@ExpressionCompatible(operandTypes = {String.class, Integer.class}, popCount = 1)
	public static final int OPCODE_GET = 26;
	public static final int OPCODE_GET_CODE = 27;
	@ExpressionCompatible(popCount = 3)
	public static final int OPCODE_SLOTS_SET = 28;
	@ExpressionCompatible(popCount = 3)
	public static final int OPCODE_SLOTS_SET_PROTO = 29;
	@ExpressionCompatible(popCount = 2) @DoesReturn
	public static final int OPCODE_SLOTS_GET = 30;
	@ExpressionCompatible(popCount = 2) @DoesReturn
	public static final int OPCODE_SLOTS_IS_DEFINED = 31;
	@ExpressionCompatible(popCount = 1) @DoesReturn
	public static final int OPCODE_SLOTS_NAMES = 32;
	@ExpressionCompatible(popCount = 1) @DoesReturn
	public static final int OPCODE_CALL_CLOSURE = 33;
	public static final int OPCODE_EXTEND_INTER_ID = 34;
	public static final int OPCODE_SHRINK_INTER_ID = 35;
	public static final int OPCODE_LOAD_THIS = 36;
	public static final int OPCODE_LOAD_NULL = 37;
	public static final int OPCODE_LOAD_LOC = 38;
	public static final int OPCODE_LOAD_ARG = 39;
	public static final int OPCODE_LOAD_INT = 40;
	public static final int OPCODE_LOAD_TRUE = 41;
	public static final int OPCODE_LOAD_FALSE = 42;
	public static final int OPCODE_LOAD_STRING = 43;
	public static final int OPCODE_LOAD_THIS_FRAME = 44;
	public static final int OPCODE_LOAD_FRAME = 45;
	public static final int OPCODE_LOAD_BEHAVIOR = 46;
