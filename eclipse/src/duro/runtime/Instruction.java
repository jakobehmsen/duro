...
public class Instruction implements Serializable {
	...
	public static final int OPCODE_CALL = 11;
	public static final int OPCODE_RET = 12;
	public static final int OPCODE_RET_THIS = 13;
	public static final int OPCODE_DEF = 14;
	public static final int OPCODE_IF_TRUE = 15;
	public static final int OPCODE_IF_FALSE = 16;
	public static final int OPCODE_JUMP = 17;
	public static final int OPCODE_SET = 18;
	public static final int OPCODE_GET = 19;
	public static final int OPCODE_LOAD_THIS = 20;
	public static final int OPCODE_LOAD_NULL = 21;
	public static final int OPCODE_LOAD_LOC = 22;
	public static final int OPCODE_LOAD_ARG = 23;
	public static final int OPCODE_LOAD_INT = 24;
	public static final int OPCODE_LOAD_FUNC = 25;
	public static final int OPCODE_LOAD_TRUE = 26;
	public static final int OPCODE_LOAD_FALSE = 27;
	public static final int OPCODE_LOAD_STRING = 28;
