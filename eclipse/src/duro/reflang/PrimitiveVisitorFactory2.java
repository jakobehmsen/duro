...
import duro.reflang.ast2.ASTClosure;
import duro.reflang.ast2.ASTString;
import duro.reflang.ast2.ASTToCode;
...
public interface PrimitiveVisitorFactory2 {
	...
	public static class IsSet implements PrimitiveVisitorFactory2 {
		@Override
		public PrimitiveVisitor2 create(ASTToCode visitor, CodeEmitter instructions, boolean mustBeExpression) {
			return new PrimitiveVisitor2() {
				@Override
	...
	public static class Receive implements PrimitiveVisitorFactory2 {
		@Override
		public PrimitiveVisitor2 create(ASTToCode visitor, CodeEmitter instructions, boolean mustBeExpression) {
			return new PrimitiveVisitor2() {
				@Override
