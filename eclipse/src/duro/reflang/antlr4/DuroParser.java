...
public class DuroParser extends Parser {
	...
	public static final int
		...
		RULE_dictProcessEntryQuotedAssignmentValue = 55, RULE_functionLiteral = 56, 
		RULE_closureLiteral = 57, RULE_behaviorParameters = 58, RULE_closureBody = 59, 
		RULE_array = 60, RULE_arrayOperand = 61, RULE_self = 62, RULE_nil = 63, 
		RULE_frame = 64, RULE_primitive = 65, RULE_primitiveArgument = 66, RULE_primitiveOperand2 = 67, 
		RULE_operationChain = 68, RULE_explicitMessageExchange = 69, RULE_memberAccess = 70, 
		RULE_indexAccess = 71, RULE_operationEnd = 72, RULE_memberAssignment = 73, 
		RULE_memberAssignmentValue = 74, RULE_memberQuotedAssignment = 75, RULE_memberQuotedAssignmentValue = 76, 
		RULE_indexAssignment = 77, RULE_indexAssignmentKey = 78, RULE_indexAssignmentValue = 79, 
		RULE_pause = 80, RULE_variableStatement = 81, RULE_variableDeclarationAndAssignment = 82, 
		RULE_variableDeclaration = 83, RULE_returnStatement = 84, RULE_breakStatement = 85, 
		RULE_yieldStatement = 86, RULE_yieldStatementExpression = 87, RULE_functionDefinition = 88, 
		RULE_functionParameters = 89, RULE_functionBody = 90, RULE_ifStatement = 91, 
		RULE_ifStatementCondition = 92, RULE_ifStatementOnTrue = 93, RULE_elseStatement = 94, 
		RULE_ifStatementOnFalse = 95, RULE_whileStatement = 96, RULE_whileStatementCondition = 97, 
		RULE_whileStatementBody = 98, RULE_forStatement = 99, RULE_forStatementInitialization = 100, 
		RULE_forStatementCondition = 101, RULE_forStatementUpdate = 102, RULE_forStatementBody = 103, 
		RULE_forInStatement = 104, RULE_forInStatementVar = 105, RULE_forInStatementBody = 106, 
		RULE_interfaceId = 107, RULE_interfaceIdBody = 108;
	public static final String[] ruleNames = {
		...
		"behaviorParameters", "closureBody", "array", "arrayOperand", "self", 
		"nil", "frame", "primitive", "primitiveArgument", "primitiveOperand2", 
		"operationChain", "explicitMessageExchange", "memberAccess", "indexAccess", 
		"operationEnd", "memberAssignment", "memberAssignmentValue", "memberQuotedAssignment", 
	...
	public final ProgramElementsContext programElements() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STRING_LITERAL) | (1L << PARAGRAPH) | (1L << NOT) | (1L << HASH) | (1L << DOLLAR) | (1L << OPEN_BRA) | (1L << OPEN_PAR) | (1L << EQUALS) | (1L << NOT_EQUALS) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUALS) | (1L << GREATER_THAN) | (1L << GREATER_THAN_OR_EQUALS) | (1L << BIN_OP1) | (1L << BIN_OP2) | (1L << INT) | (1L << COLON) | (1L << KW_VAR) | (1L << KW_PAUSE) | (1L << KW_FUNCTION) | (1L << KW_RETURN) | (1L << KW_BREAK) | (1L << KW_YIELD) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << KW_IF) | (1L << KW_THIS) | (1L << KW_NULL) | (1L << KW_FRAME) | (1L << KW_WHILE) | (1L << KW_FOR) | (1L << ID))) != 0)) {
				{
				{
				setState(220); programElementsPart();
				}
				}
				setState(225);
				_errHandler.sync(this);
	...
	public final ProgramElementContext programElement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(230); programElementContent();
			setState(232);
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(249); variableAssignment();
				}
				break;
			...
			case 3:
				...
				{
				setState(251); functionDefinition();
				}
				break;
			...
			case 9:
				...
				{
				setState(257); variableStatement();
				}
				break;
			...
			case 14:
				...
				{
				setState(262); conditionalExpression();
				}
				break;
			}
		}
	...
	public final ConditionalExpressionContext conditionalExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(265); conditionalExpressionCondition();
				setState(266); match(QUESTION_MARK);
				setState(267); conditionalExpressionTrue();
				setState(268); match(COLON);
				setState(269); conditionalExpressionFalse();
				}
				break;
	...
	public final BinaryExpressionLogicalOrContext binaryExpressionLogicalOr() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(280); binaryExpressionLogicalAnd();
			setState(284);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(281); binaryExpressionLogicalOrApplication();
					}
					} 
				}
				setState(286);
	...
	public final BinaryExpressionLogicalOrApplicationContext binaryExpressionLogicalOrApplication() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(287); match(DOUBLE_PIPE);
			setState(288); binaryExpressionLogicalAnd();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryExpressionLogicalAndContext binaryExpressionLogicalAnd() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(290); binaryExpressionEquality();
			setState(294);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(291); binaryExpressionLogicalAndApplication();
					}
					} 
				}
				setState(296);
	...
	public final BinaryExpressionLogicalAndApplicationContext binaryExpressionLogicalAndApplication() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(297); match(DOUBLE_AMP);
			setState(298); binaryExpressionEquality();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryExpressionEqualityContext binaryExpressionEquality() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(300); binaryExpressionGreaterLess();
			setState(304);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(301); binaryExpressionEqualityApplication();
					}
					} 
				}
				setState(306);
	...
	public final BinaryExpressionEqualityApplicationContext binaryExpressionEqualityApplication() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(308); binaryExpressionGreaterLess();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryExpressionGreaterLessContext binaryExpressionGreaterLess() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(310); binaryExpressionArithmetic1();
			setState(314);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(311); binaryExpressionGreaterLessApplication();
					}
					} 
				}
				setState(316);
	...
	public final BinaryExpressionGreaterLessApplicationContext binaryExpressionGreaterLessApplication() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(318); binaryExpressionArithmetic1();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryExpressionArithmetic1Context binaryExpressionArithmetic1() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(320); binaryExpressionArithmetic2();
			setState(324);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(321); binaryExpressionArithmetic1Application();
					}
					} 
				}
				setState(326);
	...
	public final BinaryExpressionArithmetic1ApplicationContext binaryExpressionArithmetic1Application() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(327); match(BIN_OP1);
			setState(328); binaryExpressionArithmetic2();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BinaryExpressionArithmetic2Context binaryExpressionArithmetic2() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(330); unaryExpressionNot();
			setState(334);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(331); binaryExpressionArithmetic2Application();
					}
					} 
				}
				setState(336);
	...
	public final BinaryExpressionArithmetic2ApplicationContext binaryExpressionArithmetic2Application() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(337); match(BIN_OP2);
			setState(338); unaryExpressionNot();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final UnaryExpressionNotContext unaryExpressionNot() throws RecognitionException {
		...
		try {
			...
			case NOT:
				enterOuterAlt(_localctx, 1);
				{
				setState(340); unaryExpressionNotApplication();
				}
				break;
			case STRING_LITERAL:
			case PARAGRAPH:
			...
			case ID:
				enterOuterAlt(_localctx, 2);
				{
				setState(341); unaryExpressionPostIncDec();
				}
				break;
			default:
	...
	public final UnaryExpressionPostIncDecContext unaryExpressionPostIncDec() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(347); unaryExpressionPostIncDecApplication();
				}
				break;
	...
	public final UnaryExpressionPostIncDecApplicationContext unaryExpressionPostIncDecApplication() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(351); unaryExpressionPostIncDecApplicationVariable();
				}
				break;

			case 2:
				{
				setState(352); unaryExpressionPostIncDecApplicationMemberAccess();
				}
				break;

			case 3:
				{
				setState(353); unaryExpressionPostIncDecApplicationIndexAccess();
				}
				break;
			}
			setState(356);
	...
	public final UnaryExpressionPostIncDecApplicationMemberAccessContext unaryExpressionPostIncDecApplicationMemberAccess() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(360); unaryExpressionPostIncDecOperand();
	...
	public final UnaryExpressionPostIncDecApplicationIndexAccessContext unaryExpressionPostIncDecApplicationIndexAccess() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(364); unaryExpressionPostIncDecApplicationIndexAccessReceiver();
	...
	public final UnaryExpressionPostIncDecApplicationIndexAccessReceiverContext unaryExpressionPostIncDecApplicationIndexAccessReceiver() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(369); unaryExpressionPostIncDecOperand();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final UnaryExpressionPostIncDecOperandContext unaryExpressionPostIncDecOperand() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(371); grouping();
				}
				break;

			case 2:
				{
				setState(372); thisMessageExchange();
				}
				break;
			...
			case 4:
				{
				setState(374); argumentParameter();
				}
				break;
	...
	public final QuotedAssignmentContext quotedAssignment() throws RecognitionException {
		...
		try {
			...
			setState(400); match(QUOTED_ASSIGN);
			setState(401); memberQuotedAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MessageExchangeContext messageExchange() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(410); messageId();
			setState(413);
			switch (_input.LA(1)) {
			case OPEN_PAR:
				{
				setState(411); messageExchangeExpressionArguments();
				}
				break;
			case STRING_LITERAL:
			case HASH:
			...
			case KW_FALSE:
				{
				setState(412); messageExchangeLiteralArguments();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final DictProcessEntryContext dictProcessEntry() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(470); dictProcessEntryRegularAssignment();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(471); dictProcessEntryPrototypeAssignment();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(472); dictProcessEntryQuotedAssignment();
				}
				break;
			}
		}
	...
	public final DictProcessEntryPrototypeAssignmentContext dictProcessEntryPrototypeAssignment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(479); messageId();
			setState(480); match(PROTO_ASSIGN);
	...
	public final DictProcessEntryQuotedAssignmentContext dictProcessEntryQuotedAssignment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(483); messageId();
			setState(484); match(QUOTED_ASSIGN);
			setState(485); dictProcessEntryQuotedAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DictProcessEntryQuotedAssignmentValueContext dictProcessEntryQuotedAssignmentValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(487); behaviorParameters();
			setState(493);
			...
			case 2:
				{
				setState(492); behaviorElementsSingle();
				}
				break;
			}
			}
	...
	public final FunctionLiteralContext functionLiteral() throws RecognitionException {
		...
		enterRule(_localctx, 112, RULE_functionLiteral);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(495); match(KW_FUNCTION);
			setState(496); match(OPEN_PAR);
			setState(497); functionParameters();
			setState(498); match(CLOSE_PAR);
			setState(499); match(OPEN_BRA);
			setState(500); functionBody();
			setState(501); match(CLOSE_BRA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ClosureLiteralContext closureLiteral() throws RecognitionException {
		...
		enterRule(_localctx, 114, RULE_closureLiteral);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(503); match(OPEN_BRA);
			setState(504); behaviorParameters();
			setState(505); closureBody();
			setState(506); match(CLOSE_BRA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BehaviorParametersContext behaviorParameters() throws RecognitionException {
		...
		enterRule(_localctx, 116, RULE_behaviorParameters);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			if (_la==SINGLE_PIPE) {
				{
				setState(508); match(SINGLE_PIPE);
				setState(512);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==ID) {
				...
				setState(515); match(SINGLE_PIPE);
				}
			}
	...
	public final ClosureBodyContext closureBody() throws RecognitionException {
		...
		enterRule(_localctx, 118, RULE_closureBody);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(518); behaviorElements();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(520); match(HASH);
			setState(521); match(OPEN_PAR);
			setState(530);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STRING_LITERAL) | (1L << PARAGRAPH) | (1L << NOT) | (1L << HASH) | (1L << DOLLAR) | (1L << OPEN_BRA) | (1L << OPEN_PAR) | (1L << EQUALS) | (1L << NOT_EQUALS) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUALS) | (1L << GREATER_THAN) | (1L << GREATER_THAN_OR_EQUALS) | (1L << BIN_OP1) | (1L << BIN_OP2) | (1L << INT) | (1L << COLON) | (1L << KW_VAR) | (1L << KW_PAUSE) | (1L << KW_FUNCTION) | (1L << KW_RETURN) | (1L << KW_BREAK) | (1L << KW_YIELD) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << KW_IF) | (1L << KW_THIS) | (1L << KW_NULL) | (1L << KW_FRAME) | (1L << KW_WHILE) | (1L << KW_FOR) | (1L << ID))) != 0)) {
				{
				setState(522); arrayOperand();
				setState(527);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final ArrayOperandContext arrayOperand() throws RecognitionException {
		...
		enterRule(_localctx, 122, RULE_arrayOperand);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SelfContext self() throws RecognitionException {
		...
		enterRule(_localctx, 124, RULE_self);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(536); match(KW_THIS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final NilContext nil() throws RecognitionException {
		...
		enterRule(_localctx, 126, RULE_nil);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(538); match(KW_NULL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FrameContext frame() throws RecognitionException {
		...
		enterRule(_localctx, 128, RULE_frame);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(540); match(KW_FRAME);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PrimitiveContext primitive() throws RecognitionException {
		...
		enterRule(_localctx, 130, RULE_primitive);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(542); match(PARAGRAPH);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STRING_LITERAL) | (1L << HASH) | (1L << OPEN_BRA) | (1L << INT) | (1L << KW_FUNCTION) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << ID))) != 0)) {
				{
				{
				setState(544); primitiveOperand2();
				}
				}
				setState(549);
				_errHandler.sync(this);
			...
			setState(550); match(OPEN_PAR);
			setState(559);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STRING_LITERAL) | (1L << PARAGRAPH) | (1L << NOT) | (1L << HASH) | (1L << DOLLAR) | (1L << OPEN_BRA) | (1L << OPEN_PAR) | (1L << EQUALS) | (1L << NOT_EQUALS) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUALS) | (1L << GREATER_THAN) | (1L << GREATER_THAN_OR_EQUALS) | (1L << BIN_OP1) | (1L << BIN_OP2) | (1L << INT) | (1L << COLON) | (1L << KW_VAR) | (1L << KW_PAUSE) | (1L << KW_FUNCTION) | (1L << KW_RETURN) | (1L << KW_BREAK) | (1L << KW_YIELD) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << KW_IF) | (1L << KW_THIS) | (1L << KW_NULL) | (1L << KW_FRAME) | (1L << KW_WHILE) | (1L << KW_FOR) | (1L << ID))) != 0)) {
				{
				setState(551); primitiveArgument();
				setState(556);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
					...
					setState(553); primitiveArgument();
					}
					}
					setState(558);
					_errHandler.sync(this);
	...
	public final PrimitiveArgumentContext primitiveArgument() throws RecognitionException {
		...
		enterRule(_localctx, 132, RULE_primitiveArgument);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PrimitiveOperand2Context primitiveOperand2() throws RecognitionException {
		...
		enterRule(_localctx, 134, RULE_primitiveOperand2);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(567);
	...
	public final OperationChainContext operationChain() throws RecognitionException {
		...
		enterRule(_localctx, 136, RULE_operationChain);
		try {
			setState(572);
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(569); explicitMessageExchange();
				}
				break;
	...
	public final ExplicitMessageExchangeContext explicitMessageExchange() throws RecognitionException {
		...
		enterRule(_localctx, 138, RULE_explicitMessageExchange);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(574); match(DOT);
			setState(575); messageExchange();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MemberAccessContext memberAccess() throws RecognitionException {
		...
		enterRule(_localctx, 140, RULE_memberAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(577); match(DOT);
			setState(578); messageId();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IndexAccessContext indexAccess() throws RecognitionException {
		...
		enterRule(_localctx, 142, RULE_indexAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(580); match(OPEN_SQ);
			setState(581); expression();
			setState(582); match(CLOSE_SQ);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OperationEndContext operationEnd() throws RecognitionException {
		...
		enterRule(_localctx, 144, RULE_operationEnd);
		try {
			setState(587);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(585); memberQuotedAssignment();
				}
				break;
	...
	public final MemberAssignmentContext memberAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 146, RULE_memberAssignment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(589); match(DOT);
			setState(590); messageId();
			setState(591);
			...
			consume();
			setState(592); memberAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MemberAssignmentValueContext memberAssignmentValue() throws RecognitionException {
		...
		enterRule(_localctx, 148, RULE_memberAssignmentValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final MemberQuotedAssignmentContext memberQuotedAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 150, RULE_memberQuotedAssignment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(596); match(DOT);
			setState(597); messageId();
			setState(598); match(QUOTED_ASSIGN);
			setState(599); memberQuotedAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MemberQuotedAssignmentValueContext memberQuotedAssignmentValue() throws RecognitionException {
		...
		enterRule(_localctx, 152, RULE_memberQuotedAssignmentValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(601); dictProcessEntryQuotedAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IndexAssignmentContext indexAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 154, RULE_indexAssignment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(603); match(OPEN_SQ);
			setState(604); indexAssignmentKey();
			setState(605); match(CLOSE_SQ);
			setState(606);
			...
			consume();
			setState(607); indexAssignmentValue();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IndexAssignmentKeyContext indexAssignmentKey() throws RecognitionException {
		...
		enterRule(_localctx, 156, RULE_indexAssignmentKey);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IndexAssignmentValueContext indexAssignmentValue() throws RecognitionException {
		...
		enterRule(_localctx, 158, RULE_indexAssignmentValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PauseContext pause() throws RecognitionException {
		...
		enterRule(_localctx, 160, RULE_pause);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(613); match(KW_PAUSE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VariableStatementContext variableStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(615); variableDeclarationAndAssignment();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(616); variableDeclaration();
				}
				break;
			}
		}
	...
	public final VariableDeclarationAndAssignmentContext variableDeclarationAndAssignment() throws RecognitionException {
		...
		enterRule(_localctx, 164, RULE_variableDeclarationAndAssignment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(619); match(KW_VAR);
	...
	public final YieldStatementContext yieldStatement() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(640); match(KW_YIELD);
			setState(641); yieldStatementExpression();
			setState(646);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					setState(643); yieldStatementExpression();
					}
					} 
				}
				setState(648);
	...
	public final YieldStatementExpressionContext yieldStatementExpression() throws RecognitionException {
		...
		enterRule(_localctx, 174, RULE_yieldStatementExpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(651); match(KW_FUNCTION);
			setState(652); messageId();
			setState(653); match(OPEN_PAR);
			setState(654); functionParameters();
			setState(655); match(CLOSE_PAR);
			setState(656); match(OPEN_BRA);
			setState(657); functionBody();
	...
	public final FunctionParametersContext functionParameters() throws RecognitionException {
		...
		enterRule(_localctx, 178, RULE_functionParameters);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		enterRule(_localctx, 180, RULE_functionBody);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(670); behaviorElements();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(672); match(KW_IF);
			setState(673); match(OPEN_PAR);
			setState(674); ifStatementCondition();
			setState(675); match(CLOSE_PAR);
			setState(676); ifStatementOnTrue();
			setState(677); elseStatement();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IfStatementConditionContext ifStatementCondition() throws RecognitionException {
		...
		enterRule(_localctx, 184, RULE_ifStatementCondition);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IfStatementOnTrueContext ifStatementOnTrue() throws RecognitionException {
		...
		enterRule(_localctx, 186, RULE_ifStatementOnTrue);
		try {
			setState(686);
	...
	public final ElseStatementContext elseStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(688); match(KW_ELSE);
				setState(689); ifStatementOnFalse();
				}
				break;
			}
			}
	...
	public final IfStatementOnFalseContext ifStatementOnFalse() throws RecognitionException {
		...
		enterRule(_localctx, 190, RULE_ifStatementOnFalse);
		try {
			setState(697);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(696); behaviorElementsSingle();
				}
				break;
			}
		}
	...
	public final WhileStatementContext whileStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(699); match(KW_WHILE);
			setState(700); match(OPEN_PAR);
			setState(701); whileStatementCondition();
			setState(702); match(CLOSE_PAR);
			setState(703); whileStatementBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final WhileStatementConditionContext whileStatementCondition() throws RecognitionException {
		...
		enterRule(_localctx, 194, RULE_whileStatementCondition);
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final WhileStatementBodyContext whileStatementBody() throws RecognitionException {
		...
		enterRule(_localctx, 196, RULE_whileStatementBody);
		try {
			setState(712);
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(707); match(OPEN_BRA);
				setState(708); programElements();
				setState(709); match(CLOSE_BRA);
				}
				break;
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(714); match(KW_FOR);
			setState(715); match(OPEN_PAR);
			setState(716); forStatementInitialization();
			setState(717); match(SEMICOLON);
			setState(718); forStatementCondition();
			setState(719); match(SEMICOLON);
			setState(720); forStatementUpdate();
			setState(721); match(CLOSE_PAR);
			setState(722); forStatementBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ForStatementInitializationContext forStatementInitialization() throws RecognitionException {
		...
		enterRule(_localctx, 200, RULE_forStatementInitialization);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STRING_LITERAL) | (1L << PARAGRAPH) | (1L << NOT) | (1L << HASH) | (1L << DOLLAR) | (1L << OPEN_BRA) | (1L << OPEN_PAR) | (1L << EQUALS) | (1L << NOT_EQUALS) | (1L << LESS_THAN) | (1L << LESS_THAN_OR_EQUALS) | (1L << GREATER_THAN) | (1L << GREATER_THAN_OR_EQUALS) | (1L << BIN_OP1) | (1L << BIN_OP2) | (1L << INT) | (1L << COLON) | (1L << KW_VAR) | (1L << KW_PAUSE) | (1L << KW_FUNCTION) | (1L << KW_RETURN) | (1L << KW_BREAK) | (1L << KW_YIELD) | (1L << KW_TRUE) | (1L << KW_FALSE) | (1L << KW_IF) | (1L << KW_THIS) | (1L << KW_NULL) | (1L << KW_FRAME) | (1L << KW_WHILE) | (1L << KW_FOR) | (1L << ID))) != 0)) {
				{
				setState(724); programElementContent();
				}
			}
	...
	public final ForStatementConditionContext forStatementCondition() throws RecognitionException {
		...
		enterRule(_localctx, 202, RULE_forStatementCondition);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ForStatementUpdateContext forStatementUpdate() throws RecognitionException {
		...
		enterRule(_localctx, 204, RULE_forStatementUpdate);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ForStatementBodyContext forStatementBody() throws RecognitionException {
		...
		enterRule(_localctx, 206, RULE_forStatementBody);
		try {
			setState(738);
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(733); match(OPEN_BRA);
				setState(734); programElements();
				setState(735); match(CLOSE_BRA);
				}
				break;
	...
	public final ForInStatementContext forInStatement() throws RecognitionException {
		...
		enterRule(_localctx, 208, RULE_forInStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(740); match(KW_FOR);
			setState(741); match(OPEN_PAR);
			setState(742); forInStatementVar();
			setState(747);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(744); forInStatementVar();
				}
				}
				setState(749);
				_errHandler.sync(this);
			...
			setState(750); match(KW_IN);
			setState(751); expression();
			setState(752); match(CLOSE_PAR);
			setState(753); forInStatementBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ForInStatementVarContext forInStatementVar() throws RecognitionException {
		...
		enterRule(_localctx, 210, RULE_forInStatementVar);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ForInStatementBodyContext forInStatementBody() throws RecognitionException {
		...
		enterRule(_localctx, 212, RULE_forInStatementBody);
		try {
			setState(765);
	...
	public final InterfaceIdContext interfaceId() throws RecognitionException {
		...
		enterRule(_localctx, 214, RULE_interfaceId);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(767); match(DOLLAR);
			setState(768); match(ID);
			setState(769); interfaceIdBody();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InterfaceIdBodyContext interfaceIdBody() throws RecognitionException {
		...
		enterRule(_localctx, 216, RULE_interfaceIdBody);
		try {
			setState(776);
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(771); match(OPEN_BRA);
				setState(772); behaviorElements();
				setState(773); match(CLOSE_BRA);
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(775); behaviorElementsSingle();
				}
				break;
			}
		}
	...
	public static final String _serializedATN =
		...
		"\n\26\f\26\16\26\u013e\13\26\3\27\3\27\3\27\3\30\3\30\7\30\u0145\n\30"+
		"\f\30\16\30\u0148\13\30\3\31\3\31\3\31\3\32\3\32\7\32\u014f\n\32\f\32"+
		"\16\32\u0152\13\32\3\33\3\33\3\33\3\34\3\34\5\34\u0159\n\34\3\35\3\35"+
		...
		"\3\64\3\64\3\64\5\64\u01d0\n\64\7\64\u01d2\n\64\f\64\16\64\u01d5\13\64"+
		"\3\64\3\64\3\65\3\65\3\65\5\65\u01dc\n\65\3\66\3\66\3\66\3\66\3\67\3\67"+
		"\3\67\3\67\38\38\38\38\39\39\39\39\39\39\59\u01f0\n9\3:\3:\3:\3:\3:\3"+
		":\3:\3:\3;\3;\3;\3;\3;\3<\3<\7<\u0201\n<\f<\16<\u0204\13<\3<\5<\u0207"+
		"\n<\3=\3=\3>\3>\3>\3>\3>\7>\u0210\n>\f>\16>\u0213\13>\5>\u0215\n>\3>\3"+
		">\3?\3?\3@\3@\3A\3A\3B\3B\3C\3C\3C\7C\u0224\nC\fC\16C\u0227\13C\3C\3C"+
