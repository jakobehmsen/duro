...
public interface DuroVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DuroParser#index}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIndex(@NotNull DuroParser.IndexContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link DuroParser#behaviorParameters}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBehaviorParameters(@NotNull DuroParser.BehaviorParametersContext ctx);
